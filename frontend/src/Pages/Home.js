  ...
  return (
    <Content>
      ...
      <p>
        ...
        <NavLink to="/guide/xup">first fleet guide</NavLink> etc, also join the in-game chat channel{" "}
        <em>TDF-Official</em>, where you will find the mailing lists for fits and other usual
      ...
      <p>
        ...
        return the contested space back to an area which can be safely occupied.
      </p>
      <p>
        Incursions are high-end PvE fleet content, well above that of regular level four missions,
        where you can earn upwards of 200mil ISK/h on average. The introduction of incursions to the
        game added some much-needed fleet content in highsec space. It also gives people a very
        controlled environment to train up their skills as a logistics pilot, as well as giving
        people a feel for organized fleets. Incursion fleets rely on buffers and resists supported
        by logistics ships in order to survive. The NPCs you face in incursions use electronic
        warfare, capacitor warfare as well as playing on speed and signature to their advantage and
        this helps to teach you many of the ingame mechanics you may face.
      </p>
    </Content>
  );
}
