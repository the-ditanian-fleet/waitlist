  ...
  return (
	<>
	  ...
	  {authContext && authContext.access["bans-view"] && (
        ...
        <GuideCard slug="/fc/acl" name="Permissions" icon={faUserCheck}>
         
        </GuideCard>
		)}
		{authContext && authContext.access["fleet-view"] && ( //fleet view should be any fc
        <GuideCard slug="/guide/hqtraineehelp" name="FC Training" icon={faGraduationCap}>
        </GuideCard>
		)}
